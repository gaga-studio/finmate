...
원본 출처와 P0 subset은 `fixtures/mydata-samples/source-dataset.md`와 `fixtures/mydata-samples/p0/`에서 확인한다. 공개 레포에는 원본 `bundles/`, 전체 `ledger_all.csv`, Excel 파일을 포함하지 않는다.
